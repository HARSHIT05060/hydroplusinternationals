...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ env('APP_URL') . '/assets/img/favicon/favicon.ico' }}" />
    ...
    <link rel="stylesheet" href="{{ env('APP_URL') . '/assets/vendor/fonts/iconify-icons.css' }}" />

    <!-- Core CSS -->
    <!-- build:css assets/vendor/css/theme.css  -->

    <link rel="stylesheet" href="{{ env('APP_URL') . '/assets/vendor/css/core.css' }}" />
    <link rel="stylesheet" href="{{ env('APP_URL') . '/assets/css/demo.css' }}" />

    <!-- Vendors CSS -->

    <link rel="stylesheet"
        href="{{ env('APP_URL') . '/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css' }}" />
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href=" {{ route('subcategory.index') }} " class="menu-link">
                            ...
                            <div class="text-truncate" data-i18n="Basic">Sub Category</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('state.index') }}" class="menu-link">
                            ...
                            <div class="text-truncate" data-i18n="Basic">State</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('city.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                            <div class="text-truncate" data-i18n="Basic">City</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('users.index') }}" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('catagory.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-grid"></i>
                            <div class="text-truncate" data-i18n="Basic">Catagory</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('subcatagory.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-file"></i>
                            <div class="text-truncate" data-i18n="Basic">Sub Catagory</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('tax.index') }}" class="menu-link">
                            ...
                            <div class="text-truncate" data-i18n="Basic">Tax</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('attributes.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-list-check"></i>
                            <div class="text-truncate" data-i18n="Basic">Attribute</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('attribute_values.index') }}" class="menu-link">
                            ...
                            <div class="text-truncate" data-i18n="Basic">Attribute Values</div>
                        </a>
                    </li> --}}
                </ul>
            </aside>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ env('APP_URL') . '/assets/img/avatars/1.png' }}" alt
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="{{ env('APP_URL') . '/assets/img/avatars/1.png' }}"
